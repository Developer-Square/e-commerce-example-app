...
const Footer = () => {
  return (
    <footer className="bg-[#111] pt-16">
      <div className="container mx-auto text-sm text-[#b7b7b7]">
        <div className="footer-items grid grid-cols-1">
          <div className="mb-7">
            <a href="#">
              <img
                className="mb-7 w-20 rounded-full md:w-1/4 lg:w-2/4 xl:w-1/6"
